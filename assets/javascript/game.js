    ...
    document.onkeyup = function (event) {
      ...
      var html = "<p>Guess what letter I'm thinking of..." + "<br /><br /><p>Wins:" + Win + "<br /><br /><p>Loses:" + Lose + "<br /><br /><p>Guesses Left:" + guessesRemaining + "<br /><br /><p>Your Guesses so far:" + guessedLetters.join(', '); //Reveal guessed letters here
